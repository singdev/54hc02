...
<body style="background-color: #d8ecef;">
    ...
    <section>
        <div>
            ...
            <div class="d-lg-flex justify-content-lg-center"><a class="btn btn-primary btn-doc" role="button" style="width: 280px;" href="consultation.php">Autoriser une nouvelle consutation</a></div>
        </div>
        <?php 
                    ...
                    <div class="card d-lg-flex justify-content-lg-center">
                        <div class="d-lg-flex card">
                            ...
                            <p class="p-hist">
                                ...
                                <a class="detail" href="fiche.php?consult3" style="color:white">Détail</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card d-lg-flex justify-content-lg-center">
                <div class="d-lg-flex card">
                    ...
                    <p class="p-hist">
                        ...
                        <a class="detail" href="fiche.php?consult2" style="color:white">Détail</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card d-lg-flex justify-content-lg-center">
                <div class="d-lg-flex card">
                    ...
                    <p class="p-hist">
                        ...
                        <a class="detail" href="fiche.php?consult1" style="color:white">Détail</a>
                    </p>
                </div>
            </div>
        </div>
